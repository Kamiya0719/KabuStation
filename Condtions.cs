	...
	class Condtions
	{
		...
		private static readonly int[] ConfirmOrs = new int[] {
			...
			*/
			...
			6096, //Score:181346, Beny:【Be1】And:-1,Or:2280,DAll:-2344,Sum:75757,Sub:181346,Sub2:5436,SB:0.4275,0:-36(0.015),1:-281(0.12),2:-585(0.25),3:-321(0.137),4:-244(0.104),5:-877(0.374),, 【Be2】1355,8008,16824,9360,9768,30442, , sT:23424, sP:5.1254, sB:0.4275, nT:75757, nP:5.9572, nB:0.5806,
			7787, //Score:181981, Beny:【Be1】And:-1,Or:6096,DAll:-1868,Sum:75836,Sub:181981,Sub2:5440,SB:0.4295,0:-23(0.012),1:-229(0.123),2:-440(0.236),3:-259(0.139),4:-201(0.108),5:-716(0.383),, 【Be2】1356,8018,16836,9371,9769,30486, , sT:23442, sP:5.125, sB:0.4295, nT:75836, nP:5.9554, nB:0.5815,
			4100, //Score:180836, Beny:【Be1】And:-1,Or:7787,DAll:-3813,Sum:79570,Sub:180836,Sub2:5417,SB:0.4135,0:-69(0.018),1:-380(0.1),2:-928(0.243),3:-471(0.124),4:-465(0.122),5:-1500(0.393),, 【Be2】1424,8388,17752,9831,10233,31942, , sT:24207, sP:5.0882, sB:0.4135, nT:79570, nP:5.9553, nB:0.5747,
			3359, //Score:181113, Beny:【Be1】And:-1,Or:4100,DAll:-3894,Sum:79730,Sub:181113,Sub2:5415,SB:0.4146,0:-70(0.018),1:-390(0.1),2:-955(0.245),3:-487(0.125),4:-474(0.122),5:-1518(0.39),, 【Be2】1426,8408,17791,9858,10243,32004, , sT:24262, sP:5.0858, sB:0.4146, nT:79730, nP:5.9515, nB:0.5739,
			8031, //Score:179947, Beny:【Be1】And:-1,Or:3359,DAll:-1456,Sum:81026,Sub:179947,Sub2:5386,SB:0.409,0:-32(0.022),1:-154(0.106),2:-380(0.261),3:-204(0.14),4:-118(0.081),5:-568(0.39),, 【Be2】1456,8542,18132,10035,10351,32510, , sT:24610, sP:5.0697, sB:0.409, nT:81026, nP:5.9277, nB:0.5691,
			6068, //Score:180253, Beny:【Be1】And:-1,Or:8031,DAll:-1676,Sum:81406,Sub:180253,Sub2:5383,SB:0.4095,0:-36(0.021),1:-164(0.098),2:-454(0.271),3:-229(0.137),4:-141(0.084),5:-652(0.389),, 【Be2】1462,8572,18245,10087,10384,32656, , sT:24698, sP:5.0661, sB:0.4095, nT:81406, nP:5.9197, nB:0.5685,
			2147, //Score:179100, Beny:【Be1】And:-1,Or:6068,DAll:-1452,Sum:82478,Sub:179100,Sub2:5371,SB:0.4024,0:-22(0.015),1:-147(0.101),2:-374(0.258),3:-191(0.132),4:-180(0.124),5:-538(0.371),, 【Be2】1478,8689,18506,10226,10531,33048, , sT:24921, sP:5.0569, sB:0.4024, nT:82478, nP:5.916, nB:0.5648,
			2738, //Score:179239, Beny:【Be1】And:-1,Or:2147,DAll:-1699,Sum:83105,Sub:179239,Sub2:5386,SB:0.3987,0:-31(0.018),1:-169(0.099),2:-388(0.228),3:-204(0.12),4:-228(0.134),5:-679(0.4),, 【Be2】1493,8741,18633,10291,10612,33335, , sT:25023, sP:5.0613, sB:0.3987, nT:83105, nP:5.9256, nB:0.5672,
			7077,
			7979, //Score:354385, Beny:【Be1】And:-1,Or:1957,DAll:-52872,Sum:52872,Sub:354385,Sub2:6176,SB:0.5482,0:-892(0.017),1:-5488(0.104),2:-11107(0.21),3:-6052(0.114),4:-7627(0.144),5:-21706(0.411),, 【Be2】892,5488,11107,6052,7627,21706, , sT:16228, sP:5.457, sB:0.5482, nT:52872, nP:6.3767, nB:0.734,
			6905, //Score:616601, Beny:【Be1】And:-1,Or:66,DAll:-50976,Sum:50976,Sub:616601,Sub2:6301,SB:0.5553,0:-841(0.016),1:-5248(0.103),2:-10669(0.209),3:-5826(0.114),4:-7401(0.145),5:-20991(0.412),, 【Be2】841,5248,10669,5826,7401,20991, , sT:15202, sP:5.5101, sB:0.5553, nT:50976, nP:6.4158, nB:0.7516,
		...
		private static void CheckCond51AllBase2(bool isAndCheck)
		{
			...
			result = "";
			foreach (CondRes c in condResAll.OrderByDescending(c => c.SortNum()).Take(200)) result += c.DispRes();
		...
		public void SetScore(int i)
		{
			...
			*/
			if (i == 3) {
				...
				subScore = Common.Round((subScore2 * -10000) * Math.Pow(noSum, 0.45) * Math.Pow(Math.Max(skipBenefit, 0.000001), 0.5));
