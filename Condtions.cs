...
namespace CSharp_sample
{
	class Condtions
	{
		...
		private const bool IsPro500AllOnly = true;
...
/*
-9:9, -4:99, -8:35, 7:342, -7:30, -2:64, -6:81, -5:83, 4:228, -3:90, 1:22, 0:35, 3:84, -12:3, -1:50, 2:26, -10:7, -11:1, -14:2, -20:1, -16:2, -18:1, -17:2, -15:2, 6:1, 5:1,   #End#
DebugCheckCond51 , T0:-3.44491130290126 , T1:-34.4383407641243 , T2:93.844 , T3:128.598 , T4:374 , T5:0.67 , T6:4.45 , T7:0.13 , T8:1301 , T9:0.81 , T10:5.31 , T11:0.14  #End#
End , T0:00:02:28.8147021  #End#

-6:4650, -5:4393, -7:2205, -3:3610, -4:3901, 7:6758, 4:14493, 3:11916, 2:4571, 1:1891, -2:2875, -1:1955, -9:475, -8:896, 0:1405, -10:260, -12:104, -13:94, -17:37, -18:22, -15:57, -16:55, 5:45, -14:71, -11:144, 6:18, -24:3, -26:2, -25:5, -27:1, -23:1, -20:4, -22:9, -21:2, -19:8,   #End#
DebugCheckCond51 , T0:-68.1032792796612 , T1:-7279.52071681867 , T2:786.736 , T3:1306.887 , T4:9423 , T5:0.29 , T6:7.58 , T7:0.14 , T8:66936 , T9:0.45 , T10:10.17 , T11:0.14  #End#

-6:301935, -5:260585, -7:158219, -3:239167, -4:264005, 7:408233, 4:763516, 3:480210, 2:190313, 1:117108, -2:176120, -8:67572, -10:16037, -9:31217, -12:5941, -11:9083, -1:124283, 0:97768, -15:2502, -14:3103, -13:4337, 6:2985, 5:5678, -16:1996, -18:1235, -20:674, -21:460, -19:802, -23:182, -17:1505, -29:15, -25:77, -22:324, -28:11, -26:66, -24:120, -27:42, -31:15, -30:9, -32:3, -34:2, -33:2, -35:1, -36:1,   #End#
DebugCheckCond51 , T0:11.9216812853516 , T1:17011.2698872797 , T2:-9948.464 , T3:-19247.87 , T4:535092 , T5:-0.17 , T6:6 , T7:0.16 , T8:3737459 , T9:0 , T10:9.23 , T11:0.16  #End#
End , T0:00:00:10.6944604  #End#

-6:4650, -5:4393, -7:2205, -3:3610, -4:3901, 7:6758, 4:14493, 3:11916, 2:4571, 1:1891, -2:2875, -1:1955, -9:475, -8:896, 0:1405, -10:260, -12:104, -13:94, -17:37, -18:22, -15:57, -16:55, 5:45, -14:71, -11:144, 6:18, -24:3, -26:2, -25:5, -27:1, -23:1, -20:4, -22:9, -21:2, -19:8,   #End#
DebugCheckCond51 , T0:195760 , T1:-68.1032792796612 , T2:-7279.52071681867 , T3:786.736 , T4:1306.887 , T5:9423 , T6:0.29 , T7:7.58 , T8:0.14 , T9:66936 , T10:0.45 , T11:10.17 , T12:0.14  #End#
End , T0:00:00:10.5587118  #End#
 */
		...
		private const bool IsKara = false;
		/** 51条件の全検証(1個スキップも可能) */
		...
		public static void DebugCheckCond51Score()
		{
			...
			if(isAllOk) {
				confirmAnds = new int[0] {  };
				confirmOrs = new int[1] { AllTrueCondIdx };
			}
		...
		private static void DebugCheckCond51ScoreBase(int[] confirmAnds, int[] confirmOrs, bool isKara)
		{
			...
			//DateTime endDate = DateTime.Parse("2024/06/10");
			...
			foreach (string symbol in codeList) {
				...
				if (IsPro500AllOnly) {
					...
					foreach (DateTime info in pro500Date[symbol]) {
						...
						for (int i = 0; i < 65; i++) {
							pro500Ds.Add(Common.GetDateByIdx(idx + i).ToString(CsvControll.DFORM));
						}
					}
			...
			Common.DebugInfo("DebugCheckCond51", debug, condRes.scores[0], condRes.scores[1], condRes.scores[2], condRes.scores[3], skipTrue,
